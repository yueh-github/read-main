...
gulp.task('copy', function () {
    ...
    gulp.src(['bower_components/jquery-md5/jquery.md5.js'])
        .pipe(gulp.dest('vendor/jquery-md5'))

    gulp.src(['bower_components/ztree_v3/**/*'])
        .pipe(gulp.dest('vendor/ztree'))

    gulp.src(['bower_components/jquery.cookie/jquery.cookie.js'])
        .pipe(gulp.dest('vendor/jquery.cookie'))

    // gulp.src(['bower_components/fullcalendar/dist/*.js', 'bower_components/fullcalendar/dist/*.css'])
    //     .pipe(gulp.dest('vendor/fullcalendar'))
    //
    // gulp.src(['bower_components/moment/min/*'])
    //     .pipe(gulp.dest('vendor/moment'))

    gulp.src(['bower_components/bootbox.js/bootbox.js'])
        .pipe(gulp.dest('vendor/bootbox.js'))

    gulp.src(['bower_components/upload/dist/upload.js'])
        .pipe(gulp.dest('vendor/upload'))
